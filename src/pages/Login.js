      ...
      <main className="page-wrapper">
        ...
        >
          ...
          <div className="overflow-hidden w-full flex leading-normal h-screen">
            <div className="mobile-hideen lg:w-8/12 flex items-center justify-center side-bg text-center text-xl font-bold text-white flex-wrap" >
            ...
            <div className="text-center w-full md:w-4/12 flex items-center justify-center p-4">
